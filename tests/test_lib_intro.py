...
@pytest.mark.parametrize(
    "message_content, expected_emoji",
    [
        (
...
async def test_generate_intro_message():
    ...
    assert (
        gh_connection_snippet not in generate_intro_message(message_content)["content"]
    )
...
async def test_generate_intro_message_with_gh_connection_suggestion():
    ...
    assert (
        dedent(gh_connection_snippet)
        in generate_intro_message(message_content)["content"]
    )
