...
@pytest.mark.parametrize('content, expected_name', [
    pytest.param("[eslint, nextjs]", "Objev od Jana: eslint, nextjs", id="comma separated strings with spaces"),
    pytest.param("[eslint,nextjs]", "Objev od Jana: eslint, nextjs", id="comma separated strings without spaces"),
    ...
    pytest.param("[eslint,nextjs, :css: CSS, ruby]", "Objev od Jana: eslint, nextjs, :css: CSS, ruby", id="emoji in the middle"),
    pytest.param("[ eslint ] Hello", "Objev od Jana: eslint", id="brackets at the beginning")])
